...
# if True:
list1=["../data/newdatasets_glue/glue_4replica.csv", "../data/newdatasets_glue/glue_5replica.csv", "../data/newdatasets_glue/glue_6replica.csv"]
list2=["../data/newdatasets_glue/first10attack1960_cnn-yelp_textbugger.csv", "../data/newdatasets_glue/first10attack1650_cnn-yelp_deepwordbug.csv"]
# for data_path_oneattack in list2:
if True:
    # for data_path in list1:
    if True:
        k_values = []
